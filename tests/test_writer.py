...
class TestMain(unittest.TestCase):
	def setUp(self):
		self.args = SimpleNamespace(debug=False, dry=False, input_tabsize=1, output_tabsize=1)
	...
	def test_toEmpty(self):
		...
		self.outline_items = parseOutline("tests/sample1/index.txt", args=self.args)
	...
	def test_fromEmpty(self):
		...
		self.outline_items = parseOutline("tests/sample5/index.txt", args=self.args)
	...
	def test_fromNonEmpty(self):
		...
		self.outline_items = parseOutline("tests/sample3/index.txt", args=self.args)
	...
	def test_NonExistingPage(self):
		...
		self.outline_items = parseOutline("tests/sample7/index.txt", args=self.args)
